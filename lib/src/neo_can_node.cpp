...
neo_can_node::neo_can_node(abstract_can_driver *a_driver, node_id_t a_node_id) : driver(a_driver), node_id(a_node_id)
{
}
...
void neo_can_node::set_node_id(node_id_t node_id)
{
    this->node_id = node_id;
}

node_id_t neo_can_node::get_node_id()
{
    return this->node_id;
}
